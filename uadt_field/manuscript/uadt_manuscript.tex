%% Oral Oncology — submission format
%% Target: Oral Oncology (Elsevier)
...
tobacco, and alcohol — creating conditions for field cancerization, in which
mucosal exposure produces independent primary tumours at multiple sites.
Taiwan's high prevalence of betel nut chewing offers a unique population to
study field cancerization epidemiology. We aimed to quantify UADT co-occurrence
rates, characterise the directionality of site-to-site transitions, and determine
the survival impact of multi-site UADT disease.

\noindent\textbf{Materials and Methods.}
We analysed a population-based cancer registry spanning 2003--2020 comprising
10,113 patients with at least one cancer at a predefined UADT field site
(ICD-O C02--C06, C09--C10, C12--C13, C15). Standardised incidence ratios
(SIR) quantified the elevation in second-primary risk compared with the general
population. Synchronous versus metachronous transitions were characterised
by a symmetry score. Survival impact of multi-site ({\geq}2 UADT sites) disease
was estimated using time-varying Cox regression to eliminate immortal-time bias,
and validated with a competing-risks DeepHit neural network model.

\noindent\textbf{Results.}
Among 10,113 UADT field patients, 1,067 (10.6\%) developed {\geq}2 field sites.
Pyriform sinus patients had the highest absolute second-primary rate (24.2\%
co-occurring with esophagus; SIR\,=\,3.78, 95\%\,CI\,2.40--5.68) followed
by hypopharynx--esophagus (16.4\%; SIR\,=\,2.86, 95\%\,CI\,1.96--4.04).
Transitions were bidirectional and predominantly synchronous (60\% within 6 months;
symmetry score 0.879, binomial $p$\,=\,0.70), consistent with shared field
exposure rather than metastasis. After immortal-time correction, multi-site
disease carried a hazard ratio for death of 2.14 (95\%\,CI\,1.97--2.33,
$p$\,<\,0.001). Competing-risks analysis confirmed 5-year cumulative incidence
of second UADT cancer of 10.4\% against a backdrop of 56.7\% all-cause mortality,
underscoring the urgency of early surveillance.

\noindent\textbf{Conclusions.}
One in four pyriform sinus patients develops a second esophageal primary.
Bidirectional, predominantly synchronous transitions and a 2.14-fold mortality
excess confirm a field cancerization mechanism. Routine early esophagoscopic
surveillance within 1--2 years of a UADT diagnosis is warranted, particularly
for pyriform sinus and hypopharynx primaries.
...
cancerization, population-based data quantifying the magnitude of
...
We analysed a 17-year population-based cancer registry from Taiwan to
...
mortality after rigorous correction for immortal-time bias.
...
Data were derived from a population-based cancer registry covering
[Institution/Region] for the period January 2003 to December 2020.
...
(v\,[version])~\citep{davidson2019}. Patients were split at the date of their
...
male ({\textgreater}90\% for all pharyngeal and esophageal sites), consistent
...
Among the 134 recorded pyriform--esophagus transitions,
60\% occurred within 6 months (synchronous), consistent across sensitivity
analyses at 3 months (57\%) and 9 months (61\%).
The symmetry score for the hypopharynx--esophagus pair was 0.879
(hypopharynx\,$\to$\,esophagus: $n$\,=\,74; reverse: $n$\,=\,60),
with a binomial test confirming no significant directional preference
($p$\,=\,0.70) (Figure~\ref{fig:trajectories}).
...
This population-based analysis of 10,113 UADT field cancer patients provides
the most comprehensive characterisation of field cancerization in a
betel-nut-endemic cohort to date. Three findings have direct clinical implications.
...
Strengths include the population-based design (minimising referral bias),
17-year follow-up, pre-registration of primary hypotheses and site definitions,
and the use of both SIR (population-referenced) and time-varying Cox
(within-cohort, bias-corrected) methods.

Limitations include: (i) absence of clinical stage, treatment, and
betel nut / smoking status in the registry, precluding adjustment for
these confounders; (ii) surveillance bias — patients with one UADT cancer
...
Floor of mouth (C04) & Hypopharynx (C13) & 5 & 1.17 & 4.27 & 1.39--9.96 & 0.040 \\
...
Hypopharynx (C13) & Esophagus (C15)   & 32 & 11.2 & 2.86 & 1.96--4.04 & $<$0.001 \\
Tonsil (C09)      & Esophagus (C15)   & 28 & 11.85 & 2.36 & 1.57--3.41 & $<$0.001 \\
Esophagus (C15)   & Tonsil (C09)      & 10 & 4.32 & 2.31 & 1.11--4.25 & 0.068 \\
\bottomrule
\end{tabular}\\[0.5em]
...
Age (continuous)        & [value] & [CI] & [p] \\
Sex (male vs.\ female)  & [value] & [CI] & [p] \\
\bottomrule
\end{tabular}\\[0.5em]
\small HR: hazard ratio. $\Delta$HR between models: 1.28.
\small [value] placeholders to be filled from cox\_results.csv.
\end{table}
...
\begin{figure}[ht]
  ...
  in the Taiwan Cancer Registry, 2003--2020.
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\textwidth]{fig4a_trajectory_network.png}
  ...
  edge colour indicates the synchronous fraction (darker = higher proportion
  within 6 months). The bidirectionality of the pyriform--esophagus and
  hypopharynx--esophagus arcs (symmetry\,=\,0.879) supports a field
  mechanism rather than directional spread.}
...
\begin{figure}[ht]
  ...
  \begin{minipage}{0.48\textwidth}
    \includegraphics[width=\textwidth]{fig5a_km_curves.png}
  \end{minipage}\hfill
  \begin{minipage}{0.48\textwidth}
