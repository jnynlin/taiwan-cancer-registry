...
characterise the landscape of cancer co-occurrence in a large hospital-based
institutional registry using convergent unsupervised machine-learning methods.

\textbf{Methods:}
We analysed 78,578 patients (84,157 primary cancers) from the China Medical
University Hospital (CMUH) Cancer Registry (2006--2020). Three independent unsupervised methods were applied to
...
In this study we applied all three approaches to the full CMUH Cancer Registry
...
De-identified records were obtained from the China Medical University Hospital
(CMUH) institutional cancer registry, covering the period 2006--2020. The
registry captures all newly diagnosed cancers at CMUH and follows the structure
of the national reporting standard~\cite{Chiang2019}. Each record encodes the ICD-O topography code (third
...
site-specific second-primary SIR values reported in a hospital-based institutional
registry setting \cite{Chuang2008, Morris2011}.
