...
protective at full follow-up. Prospective real-world data with complete
staging and longitudinal quality-of-life outcomes are required to
characterise the optimal CCRT indication in Taiwanese patients.
...
Third, Schoenfeld residual testing identified three covariates with
...
Fifth, the autoencoder used mean-squared-error loss uniformly across all
...
Sixth, the cluster OS differences likely partly reflect known compositional
...
Seventh, no comparison against PCA-based clustering was performed; it remains
